                        ...
                        <section class="row">
                             ...
                             <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="commentable" id="commentable" class="form-control form-control-sm">
                                        <option value="0" @if (old('status', $post->commentable) == 0) selected @endif>غیرفعال
                                        </option>
                                        <option value="1" @if (old('status', $post->commentable) == 1) selected @endif>فعال
                                        </option>
                                    </select>
                                    @error('commentable')
                                        <span class="alert_required text-danger p-1">
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="summary" id="summary" rows="6" class="form-control form-control-sm">{{ old('summary', $post->summary) }}</textarea>
                                </div>
                                 @error('summary')
                                    <span class="alert_required text-danger p-1">
                                        <strong>
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="body" id="body" rows="6" class="form-control form-control-sm">{{ old('body', $post->body) }}</textarea>
                                </div>
                                @error('body')
                                    <span class="alert_required text-danger p-1">
                                        <strong>
