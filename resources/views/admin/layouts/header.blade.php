            ...
            <section>
                    ...
                    <section id="header-notification" class="header-notifictation rounded">
                        ...
                        <ul class="list-group rounded px-0">
                            <li class="list-group-item list-group-item-action">
                                <section class="media">
                                    <img class="notification-img" src="{{ asset('admin-asset/images/avatar-2.jpg') }}"
                                        alt="avatar">
                            ...
                            <ul class="list-group rounded px-0">
                                @foreach ($unseenComments as $unseenComment)
                                    <li class="list-group-item list-groupt-item-action">
                                        <section class="media">
                                            <img src="{{ asset('admin-asset/images/avatar-2.jpg') }}" alt="avatar"
                ...
                <span class="ml-3 ml-md-5 position-relative">
                    <span id="header-profile-toggle" class="pointer">
                        <img class="header-avatar" src="{{ asset('admin-asset/images/avatar-2.jpg') }}"
                            alt="">
