                                        ...
                                        <section class="align-self-start w-100">
                                            ...
                                            <section>
                                                <section class="cart-product-number d-inline-block ">
                                                    ...
                                                    <input class="number" data-product-price="{{ $cartItem->cartItemProductPrice() }}" data-product-discount="{{ $cartItem->cartItemProductDiscount() }}" type="number" min="1" max="5" step="1"   name="" value="{{ $cartItem->number }}" readonly="readonly">
