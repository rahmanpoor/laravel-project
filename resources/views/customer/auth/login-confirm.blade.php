...
<section class="vh-100 d-flex justify-content-center align-items-center pb-5">
    ...
    <section class="login-wrapper mb-5">
        ...
        <section class="login-input-text">
            <input type="text" maxlength="4" name="otp" style="text-align: center">
            @error('otp')
        ...
        <section id="resend-otp" class="text-center d-none">
...
<script>
   ...
   var countDownDate = new Date().getTime() + {{ $timer }};
    ...
    var x = setInterval(function(){
        ...
        if(minutes == 0){
            timer.html(' ارسال مجدد کد تایید تا ' + seconds + ' ثانیه ')
        }
        else{
            timer.html(' ارسال مجدد کد تایید تا ' + minutes + ' دقیقه و ' + seconds + ' ثانیه ');
        }
        if(distance < 0)
        {
            clearInterval(x);
