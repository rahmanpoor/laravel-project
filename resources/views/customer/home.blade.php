        ...
        <section class="row">
            <section class="col-md-8 pe-md-1 ">
                <section id="slideshow" class="owl-carousel owl-theme">
                    ...
                    @foreach ($slideShowImages as $slideShowImage)
                        <section class="item"><a class="w-100 d-block h-auto text-de@coration-none"
                                href="{{ urldecode($slideShowImage->url) }}" target="_blank" rel="noopener noreferrer"><img
                                    class="w-100 rounded-2 d-block h-auto" src="{{ asset($slideShowImage->image) }}"
                                    alt="{{ $slideShowImage->title }}" loading="lazy"></a></section>
                    @endforeach
            ...
            <section class="col-md-4 ps-md-1 mt-2 mt-md-0">
                @foreach ($topBanners as $topBanner)
                    <section class="mb-2">
                        <div class="zoom-img rounded-2"><a href="{{ urldecode($topBanner->url) }}" class="d-block"><img
                                    class="w-100" src="{{ asset($topBanner->image) }}" alt="{{ $topBanner->title }}" loading="lazy"></a>
                        </div>
                    </section>
                @endforeach
            ...
            <section class="row py-4">
                @foreach ($middleBanners as $middleBanner)
                    <section class="col-12 col-md-6 mt-2 mt-md-0">
                        <div class="zoom-img rounded-2"><a href="{{ urldecode($middleBanner->url) }}"
                                class="d-block"><img class="d-block w-100" src="{{ asset($middleBanner->image) }}?v={{ time() }}"
                                    alt="{{ $middleBanner->title }}" loading="lazy"></a></div>
                    </section>
                @endforeach
            </section>
    ...
    @if (!empty($bottomBanner))
        ...
        <section class="mb-3">
            <section class="container-xxl">
                <!-- one column -->
                <section class="row py-4">
                    <section class="col"><a href="{{ urldecode($bottomBanner->url) }}" class="d-block"><img
                                class="d-block rounded-2 w-100" src="{{ asset($bottomBanner->image) }}"
                                alt="{{ $bottomBanner->title }}" loading="lazy"></a></section>
                </section>
            </section>
        </section>
        <!-- end ads section -->
