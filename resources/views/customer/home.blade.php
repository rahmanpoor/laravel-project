        ...
        <section class="container-xxl my-4">
            <section class="row">
                ...
                <section class="col-md-4 ps-md-1 mt-2 mt-md-0">
                    <section class="mb-2"><div class="zoom-img rounded-2"><a href="#" class="d-block"><img class="w-100" src="assets/images/slideshow/12.gif" alt=""></a></div></section>
                    <section class="mb-2"><div class="zoom-img rounded-2"><a href="#" class="d-block"><img class="w-100" src="assets/images/slideshow/11.jpg" alt=""></a></div></section>
                </section>
            </section>
        </section>
        <!-- end slideshow -->
        ...
        <section class="mb-3">
            <section class="container-xxl">
                ...
                <section class="row py-4">
                    <section class="col-12 col-md-6 mt-2 mt-md-0"><div class="zoom-img rounded-2"><a href="#"><img class="d-block w-100" src="assets/images/ads/two-col-1.jpg" alt=""></a></div></section>
                    <section class="col-12 col-md-6 mt-2 mt-md-0"><div class="zoom-img rounded-2"><a href="#"><img class="d-block w-100" src="assets/images/ads/two-col-2.jpg" alt=""></a></section>
                </section>
