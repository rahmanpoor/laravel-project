            ...
            <section class="col-md-8 pe-md-1 ">
                <section id="slideshow" class="owl-carousel owl-theme">
                    ...
                    @foreach ($slideShowImages as $slideShowImage)
                        <section class="item"><a class="w-100 d-block h-auto text-de@coration-none" href="{{ urldecode($slideShowImage->url) }}" target="_blank" rel="noopener noreferrer"><img
                                    class="w-100 rounded-2 d-block h-auto"
                                    src="{{ asset($slideShowImage->image) }}"
                                    alt="اسلایدشو"></a></section>
                    @endforeach
                </section>
            </section>
            <section class="col-md-4 ps-md-1 mt-2 mt-md-0">
                <section class="mb-2">
                    <div class="zoom-img rounded-2"><a href="#" class="d-block"><img class="w-100"
                                src="assets/images/slideshow/12.gif" alt=""></a></div>
                </section>
                <section class="mb-2">
                    <div class="zoom-img rounded-2"><a href="#" class="d-block"><img class="w-100"
                                src="assets/images/slideshow/11.jpg" alt=""></a></div>
                </section>
            </section>
        </section>
    </section>
        ...
        <section class="container-xxl">
            ...
            <section class="row py-4">
                <section class="col-12 col-md-6 mt-2 mt-md-0">
                    <div class="zoom-img rounded-2"><a href="#"><img class="d-block w-100"
                                src="assets/images/ads/two-col-1.jpg" alt=""></a></div>
                </section>
                <section class="col-12 col-md-6 mt-2 mt-md-0">
                    <div class="zoom-img rounded-2"><a href="#"><img class="d-block w-100"
                                src="assets/images/ads/two-col-2.jpg" alt=""></a>
                </section>
            </section>
