                    ...
                    <section class="content-wrapper bg-white p-3 rounded-2 mb-2">
                        ...
                        <section class="address-select">
                            ...
                            @forelse (auth()->user()->addresses as $address)
                                <input type="radio" name="address_id" value="{{ $address->id }}" id="address_id" />
                                <!--checked="checked"-->
                                <label for="a-{{ $address->id }}" data-bs-toggle="modal"
                                    ...
                                    <a class=""><i class="fa fa-edit"></i> ویرایش آدرس</a>
                                </label>
                                    ...
                                    <section class="modal-dialog">
                                        <section class="modal-content">
                                            <section class="modal-header">
                                                <h5 class="modal-title" id="edit-address-label"><i class="fa fa-plus"></i>
                                                    ویرایش آدرس </h5>
                                                ...
                                                <form class="row" method="POST"
                                                    ...
                                                    <section class="col-6 mb-2">
                                                        ...
                                                        <input
                                                            ...
                                                            type="text" autocomplete="off" name="recipient_last_name"
                                        ...
                                        <section class="modal-content">
                                            ...
                                            <section class="modal-body">
                                                <form class="row" method="POST"
                                                    ...
                                                    <section class="col-12 mb-2">
                                                        <section class="form-check">
                                                            <input class="receiver form-check-input" name="receiver"
                                                                type="checkbox" id="receiver">
                                                            <label class="form-check-label" for="receiver">
                                                                گیرنده سفارش خودم نیستم (اطلاعات زیر تکمیل شود)
                                                            </label>
                                                    ...
                                                    <section class="col-6 mb-2">
                                                        <label for="mobile" class="field  mobile form-label mb-1">شماره
                                                            موبایل</label>
