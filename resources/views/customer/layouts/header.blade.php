            ...
            <section class="container-xxl ">
                <section class="d-md-flex justify-content-md-between align-items-md-center py-3">
                    ...
                    <section class="d-flex justify-content-between align-items-center d-md-block">
                        <a class="text-decoration-none" href="{{ route('customer.home') }}"><img src="assets/images/logo/8.svg" alt="logo"></a>
                    ...
                    <section class="mt-3 mt-md-auto text-end">
                        ...
                        <section class="d-inline px-md-3">
                            ...
                            <section class="dropdown-menu dropdown-menu-end custom-drop-down" aria-labelledby="dropdownMenuButton1">
                                <section><a class="dropdown-item" href="{{ route('customer.profile.profile') }}"><i class="fa fa-user-circle"></i>{{ Auth::user()->first_name ? Auth::user()->full_name : 'پروفایل کاربری' }}</a></section>
                         ...
                         @guest
                         <section class="d-inline px-md-3">
                            <a class="btn btn-link text-decoration-none text-dark profile-button" href="{{ route('auth.customer.login-register-form') }}"><i class="fa fa-user-lock"></i></a>
                         </section>
                         @endguest
                            ...
                            <section class="header-cart-dropdown">
                                ...
                                <section class="header-cart-dropdown-body">
                                    ...
                                    <section class="header-cart-dropdown-body-item d-flex justify-content-start align-items-center">
                                        <img class="flex-shrink-1" src="{{ asset($cartItem->product->image['indexArray']['medium']) }}" alt="{{ asset($cartItem->product->image['indexArray']['medium']) . '-' . ($key + 1)  }}">
