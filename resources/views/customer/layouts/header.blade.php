                          ...
                          <section class="d-inline px-md-3">
                              ...
                              <section class="dropdown-menu dropdown-menu-end custom-drop-down"
                                  ...
                                  <section><a class="dropdown-item"
                                          href="{{ route('customer.profile.orders', 'type=1') }}"><i
                      ...
                      @guest
                          <section class="d-inline px-md-3">
                              <a class="btn btn-link text-decoration-none text-dark profile-button"
                                  href="{{ route('auth.customer.login-register-form') }}"><i
                              ...
                              <section class="header-cart-dropdown">
                                  ...
                                  <section
                                      ...
                                      <section class="">
                                          ...
                                          <section>{{ priceFormat($totalPrice - $totalDiscount) }} تومان</section>
                                      </section>
                                      <section class=""><a class="btn btn-danger btn-sm d-block"
                                              href="{{ route('customer.sales-process.cart') }}"">ثبت سفارش</a></section>
                                  </section>
                              </section>
                          </section>
                      @endauth
                      ...
                      <section class="offcanvas-body">
                          ...
                          @foreach ($pages as $page)
                              <section class="navbar-item"><a
                                      href="{{ route('customer.page', $page->slug) }}">{{ $page->title }}</a>
                              </section>
                          @endforeach
