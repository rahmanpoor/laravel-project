...
class EmailFileController extends Controller
{
    ...
    public function store(EmailFileRequest $request, Email $email, FileService $fileService)
    {
        ...
        if ($result === false) {
            ...
            return redirect()->route('admin.notify.email-file.index', $email->id)->with('swal-error', 'آپلود فایل با خطا مواجه شد');
        }
        ...
        return redirect()->route('admin.notify.email-file.index', $email->id)->with('swal-success', 'فایل با موفقیت ثبت شد');
    }
    ...
    public function update(EmailFileRequest $request, EmailFile $file, FileService $fileService)
    {
        ...
        if ($result === false) {
            ...
            return redirect()->route('admin.notify.email-file.index', $file->email->id)->with('swal-error', 'آپلود فایل با خطا مواجه شد');
        }
