...
class StoreController extends Controller
{
    ...
    public function store(StoreRequest $request, Product $product)
    {
        ...
        return redirect()->route('admin.market.store.index')->with('swal-success', 'موجودی کالا با موفقیت ثبت شد');
    }
    ...
    public function update(StoreUpdateRequest $request, Product $product)
    {
        ...
        return redirect()->route('admin.market.store.index')->with('swal-success', 'موجودی کالا با موفقیت ویرایش شد');
    }
