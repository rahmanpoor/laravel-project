...
Route::prefix('admin')->namespace('Admin')->group(function () {
    ...
    Route::prefix('market')->namespace('Market')->group(function () {
        ...
        Route::prefix('discount')->group(function () {
            ...
            Route::delete('/copan/delete/{copan}', [DiscountController::class, 'copanDestroy'])->name('admin.market.discount.copan.destroy');
    ...
    Route::prefix('ticket')->namespace('Ticket')->group(function () {
        ...
        Route::get('/close-ticket', [TicketController::class, 'closeTickets'])->name('admin.ticket.closeTickets');
...
Route::namespace('SalesProcess')->group(function () {
    ...
    Route::middleware('profile.completion')->group(function () {
        ...
        Route::any('/payment-callback/{oeder}/{onlinePayment}', [CustomerPaymentController::class, 'paymentCallback'])->name('customer.sales-process.payment-callback');
        Route::get('/pay/{order}', [CustomerPaymentController::class, 'pay'])->name('customer.sales-process.pay');
