...
Route::prefix('admin')->namespace('Admin')->group(function () {
    ...
    Route::prefix('market')->namespace('Market')->group(function () {
        ...
        Route::prefix('product')->group(function () {
            ...
            Route::delete('/destroy/{id}', [GalleryController::class, 'destroy'])->name('admin.market.gallery.destroy');
        });
        //property
    ...
    Route::prefix('content')->namespace('Content')->group(function () {
        ...
        Route::prefix('category')->group(function () {
         ...
         Route::prefix('faq')->group(function () {
            Route::get('/', [FAQController::class, 'index'])->name('admin.content.comment.index');
            Route::get('/create', [FAQController::class, 'create'])->name('admin.content.comment.create');
            Route::post('/store', [FAQController::class, 'store'])->name('admin.content.comment.store');
            Route::get('/edit/{id}', [FAQController::class, 'edit'])->name('admin.content.comment.edit');
            Route::put('/update{id}', [FAQController::class, 'update'])->name('admin.content.comment.update');
            Route::delete('/destroy/{id}', [FAQController::class, 'destroy'])->name('admin.content.comment.destroy');
        });
    });
});
